...
public final class MeshyConfig {
    ...
    public static TaczConfigSpec.BooleanValue ENABLE_MESH;
    public static TaczConfigSpec.BooleanValue POLY_IN_SHADOW;
    public static TaczConfigSpec.DoubleValue MAX_RENDER_DISTANCE;
    public static TaczConfigSpec.BooleanValue POLY_IN_PREVIEW;
    public static TaczConfigSpec.BooleanValue LOG_STATS;
    public static TaczConfigSpec.BooleanValue GPU_BAKING;
    public static TaczConfigSpec.BooleanValue GPU_WORLD;
    public static TaczConfigSpec.IntValue GPU_LIGHT_CACHE_SIZE;
    public static TaczConfigSpec.IntValue GPU_BAKE_BUDGET_PER_FRAME;
    public static TaczConfigSpec.BooleanValue GPU_UNDER_SHADERS;
    public static TaczConfigSpec.BooleanValue POLY_MIRROR_REVERSE_WINDING;
    public static TaczConfigSpec.BooleanValue POLY_INVERT_NORMALS;
    public static TaczConfigSpec.BooleanValue POLY_PREFER_PACK_NORMALS;
    public static TaczConfigSpec.IntValue GUI_MAX_VERTICES;
    public static TaczConfigSpec.IntValue WORLD_MAX_VERTICES;
    public static TaczConfigSpec.DoubleValue WORLD_FULL_DETAIL_DISTANCE;
    public static TaczConfigSpec.IntValue MAX_MODEL_VERTICES;
