...
public enum ClientAssetsManager {
    ...
    private List<IdentifiableReloadListener> listeners;
    ...
    public void reloadAndRegister(Consumer<IdentifiableReloadListener> register) {
        if (listeners == null) {
            ...
            register(new IdentifiableReloadListener() {
    ...
    private <T extends IdentifiableReloadListener> T register(T listener) {
    ...
    public static void reloadAllPack() {
        try {
            ...
            if (TaczCommonEvents.getServer() != null) {
                // 直接刷新data
