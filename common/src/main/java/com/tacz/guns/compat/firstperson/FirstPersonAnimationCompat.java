 ...
 * other mod's control, while a TACZ {@link AnimateGeoItemRenderer} with a loaded
...
public final class FirstPersonAnimationCompat {
    ...
    public static void init() {
        if (Platform.INSTANCE.isModLoaded(FIRST_PERSON_MODEL)) {
    ...
    private static void setNeaFirstPersonArm(boolean rendering) {
        if (!Platform.INSTANCE.isModLoaded(NOT_ENOUGH_ANIMATIONS)) {
            return;
        }
        try {
