...
public class RenderConfig {
    public static TaczConfigSpec.BooleanValue ENABLE_LASER_FADE_OUT;
    public static TaczConfigSpec.BooleanValue ILLUMINATED_REAL_SKY;
    public static TaczConfigSpec.IntValue GUN_LOD_RENDER_DISTANCE;
    public static TaczConfigSpec.IntValue BULLET_HOLE_PARTICLE_LIFE;
    public static TaczConfigSpec.DoubleValue BULLET_HOLE_PARTICLE_FADE_THRESHOLD;
    public static TaczConfigSpec.EnumValue<CrosshairType> CROSSHAIR_TYPE;
    public static TaczConfigSpec.DoubleValue HIT_MARKET_START_POSITION;
    public static TaczConfigSpec.BooleanValue HEAD_SHOT_DEBUG_HITBOX;
    /** 瞄准镜镜内裁剪（目镜掩码）总开关。默认<b>开启</b>。 */
    public static TaczConfigSpec.BooleanValue SCOPE_MASK_ENABLE;
    ...
    public static TaczConfigSpec.EnumValue<IrisScopeMaskInjection> IRIS_SCOPE_MASK_INJECTION;
    /** 【调试】把瞄具目镜掩码贴图画到屏幕左上角，用于排查离屏渲染链路。默认关闭。 */
    public static TaczConfigSpec.BooleanValue SCOPE_MASK_DEBUG;
    public static TaczConfigSpec.BooleanValue SCOPE_MASK_HULL_FILL;
    /** 开镜掩码激活时，物理目镜框 {@code ocular_ring} 摘除主提交并以未裁剪 RenderType 重画（上游 stencil-ALWAYS 语义）。默认<b>开启</b>。 */
    public static TaczConfigSpec.BooleanValue SCOPE_OCULAR_RING_FIX;
    /** 低倍/红点通道（含组合镜低倍组）激活时，镜身不做目镜掩码裁剪（上游 renderSight 无条件绘制镜身）。默认<b>开启</b>。 */
    public static TaczConfigSpec.BooleanValue SCOPE_SIGHT_CLIP_FIX;
    /**
     ...
     */
    public static TaczConfigSpec.BooleanValue SCOPE_SIGHT_RETICLE_CLIP;
    public static TaczConfigSpec.BooleanValue GUN_HUD_ENABLE;
    public static TaczConfigSpec.BooleanValue KILL_AMOUNT_ENABLE;
    public static TaczConfigSpec.DoubleValue KILL_AMOUNT_DURATION_SECOND;
    public static TaczConfigSpec.IntValue TARGET_RENDER_DISTANCE;
    public static TaczConfigSpec.BooleanValue FIRST_PERSON_BULLET_TRACER_ENABLE;
    public static TaczConfigSpec.BooleanValue TRACER_DEBUG;
    public static TaczConfigSpec.ConfigValue<String> TRACER_DEBUG_GUN;
    public static TaczConfigSpec.IntValue TRACER_DEBUG_INTERVAL_MS;
    public static TaczConfigSpec.IntValue TRACER_DEBUG_FIRST_TICKS;
    public static TaczConfigSpec.BooleanValue SHELL_EJECTION_DEBUG;
    public static TaczConfigSpec.BooleanValue LASER_DEBUG;
    public static TaczConfigSpec.ConfigValue<String> SHELL_EJECTION_DEBUG_GUN;
    public static TaczConfigSpec.IntValue SHELL_EJECTION_DEBUG_INTERVAL_MS;
    public static TaczConfigSpec.BooleanValue RECOIL_DEBUG;
    /** 【RecoilDebug 隔离】运行时关闭枪口火光渲染（定位斜向侧偏视觉载体用）。默认 false=正常渲染。 */
    public static TaczConfigSpec.BooleanValue DEBUG_DISABLE_MUZZLE_FLASH;
    /** 【RecoilDebug 隔离】运行时关闭第一人称抛壳。 */
    public static TaczConfigSpec.BooleanValue DEBUG_DISABLE_SHELL;
    /** 【RecoilDebug 隔离】运行时关闭曳光弹道实体渲染。 */
    public static TaczConfigSpec.BooleanValue DEBUG_DISABLE_TRACER;
    /** 【RecoilDebug 隔离】运行时关闭摄像机动画（镜头摇动）的两处消费（世界叠加 + 手部旋转），含数据清理。 */
    public static TaczConfigSpec.BooleanValue DEBUG_DISABLE_CAMERA_ANIM;
    /**
     ...
     */
    public static TaczConfigSpec.BooleanValue HAND_VIEW_LOCK_FIX;
    /**
     ...
     */
    public static TaczConfigSpec.BooleanValue CONSTRAINT_BASE_COMPENSATE;
    /**
     ...
     */
    public static TaczConfigSpec.IntValue CONSTRAINT_COMPENSATE_MODE;
    /**
     ...
     */
    public static TaczConfigSpec.BooleanValue HAND_VIEW_LOCK_NORMALIZE;
    /**
     ...
     */
    public static TaczConfigSpec.BooleanValue IRIS_HAND_PHASE_SPLIT_FIX;
    public static TaczConfigSpec.BooleanValue DISABLE_INTERACT_HUD_TEXT;
    public static TaczConfigSpec.BooleanValue AUTO_SELECT_GUN_SMITH_TABLE_FILTER;
    public static TaczConfigSpec.IntValue DAMAGE_COUNTER_RESET_TIME;
    public static TaczConfigSpec.BooleanValue DISABLE_MOVEMENT_ATTRIBUTE_FOV;
    public static TaczConfigSpec.BooleanValue ENABLE_TACZ_ID_IN_TOOLTIP;
    public static TaczConfigSpec.BooleanValue BLOCK_ENTITY_TRANSLUCENT;
    /**
     ...
     */
    public static TaczConfigSpec.BooleanValue SCOPE_PIP_ENABLE;
    /** 开镜进度低于该值时不做 PIP（此时孔径几乎闭合，拷贝纯属浪费）。 */
    public static TaczConfigSpec.DoubleValue SCOPE_PIP_MIN_AIMING_PROGRESS;
    /**
     ...
     */
    public static TaczConfigSpec.DoubleValue SCOPE_PIP_MIN_MAGNIFICATION;
    /**
     * 镜内锐化强度（0 = 关）。
     *
     ...
     */
    public static TaczConfigSpec.DoubleValue SCOPE_PIP_SHARPNESS;
    /**
     ...
     */
    public static TaczConfigSpec.DoubleValue SCOPE_PIP_WORLD_ZOOM_SHARE;
    /**
     ...
     */
    public static TaczConfigSpec.DoubleValue AIMING_SWAY_INTENSITY;
    /**
     * 允许在光影包启用时也跑 PIP。默认<b>关闭</b>。
     *
     * <p>关闭是保守默认，不是「已知不兼容」—— 见 {@code ScopePipRenderer} 里的说明。
     */
    public static TaczConfigSpec.BooleanValue SCOPE_PIP_ALLOW_SHADER_PACKS;
    /**
     ...
     */
    public static TaczConfigSpec.BooleanValue SCOPE_PIP_RERENDER;
    /**
     ...
     */
    public static TaczConfigSpec.DoubleValue SCOPE_PIP_RESOLUTION_SCALE;
    /**
     ...
     */
    public static TaczConfigSpec.IntValue SCOPE_PIP_RERENDER_INTERVAL;
    /**
    ...
    public static TaczConfigSpec.DoubleValue SCOPE_PIP_SHADOW_SCALE;
    public static TaczConfigSpec.BooleanValue SCOPE_PIP_ISOLATE_PIPELINE;
    /**
     ...
     */
    public static TaczConfigSpec.BooleanValue SCOPE_PIP_DEBUG_NO_COMPOSITE;
    /**
     * 【诊断】把镜内那一遍期间的渲染目标解析顺序打进日志（只记前几帧）。
     * 见 {@code ScopePipTrace} 的类注释 —— 这个症状靠静态分析已经连错四次。
     */
    public static TaczConfigSpec.BooleanValue SCOPE_PIP_DEBUG_TRACE;
    /**
     * 【诊断】把合成实际覆盖到的区域涂成纯品红。
     * 整屏变品红 = 合成没被掩码约束住；只有镜片变品红 = 合成是对的，溢出来自别处。
     */
    public static TaczConfigSpec.BooleanValue SCOPE_PIP_DEBUG_PAINT_LENS;
    /**
     ...
     */
    public static TaczConfigSpec.BooleanValue SCOPE_PIP_RELEASE_IDLE_PIPELINE;
    /**
     * 【实验配套】空闲释放前要连续空闲多少帧（默认 120 ≈ 2 秒 @60fps），
     * 防开镜/收镜过渡噪声把管线反复拆建。
     */
    public static TaczConfigSpec.IntValue SCOPE_PIP_IDLE_RELEASE_DELAY_FRAMES;
    /**
     * 【诊断】每 600 帧打一次瞄具/主管线各自的 GPU 纹理字节数与 scope pass 累计数，
     * 量化「衰减是否随 scope pass 次数在显存侧累积」。默认关。
     */
    public static TaczConfigSpec.BooleanValue SCOPE_PIP_DEBUG_GPU_MEM;
