...
public class SoundConfig {
    public static TaczConfigSpec.IntValue HIT_SOUND_CONCURRENCY_LIMIT;
    public static TaczConfigSpec.IntValue DEFAULT_SOUND_CONCURRENCY_LIMIT;
    public static TaczConfigSpec.IntValue HIGH_FREQUENCY_SOUND_CONCURRENCY_LIMIT;
    public static TaczConfigSpec.BooleanValue FIRST_PERSON_ANIMATION_SOUND_TRACKING;
