...
public class AmmoConfig {
    public static TaczConfigSpec.BooleanValue EXPLOSIVE_AMMO_DESTROYS_BLOCK;
    public static TaczConfigSpec.BooleanValue EXPLOSIVE_AMMO_FIRE;
    public static TaczConfigSpec.BooleanValue EXPLOSIVE_AMMO_KNOCK_BACK;
    public static TaczConfigSpec.IntValue EXPLOSIVE_AMMO_VISIBLE_DISTANCE;
    public static TaczConfigSpec.ConfigValue<List<String>> PASS_THROUGH_BLOCKS;
    public static TaczConfigSpec.BooleanValue DESTROY_GLASS;
    public static TaczConfigSpec.BooleanValue IGNITE_BLOCK;
    public static TaczConfigSpec.BooleanValue IGNITE_ENTITY;
    public static TaczConfigSpec.DoubleValue GLOBAL_BULLET_SPEED_MODIFIER;
