...
public class GunConfig {
    public static TaczConfigSpec.IntValue DEFAULT_GUN_FIRE_SOUND_DISTANCE;
    public static TaczConfigSpec.IntValue DEFAULT_GUN_SILENCE_SOUND_DISTANCE;
    public static TaczConfigSpec.IntValue DEFAULT_GUN_OTHER_SOUND_DISTANCE;
    public static TaczConfigSpec.BooleanValue CREATIVE_PLAYER_CONSUME_AMMO;
    public static TaczConfigSpec.BooleanValue AUTO_RELOAD_WHEN_RESPAWN;
