...
public class OtherConfig {
    public static TaczConfigSpec.BooleanValue DEFAULT_PACK_DEBUG;
    public static TaczConfigSpec.IntValue TARGET_SOUND_DISTANCE;
    public static TaczConfigSpec.DoubleValue SERVER_HITBOX_OFFSET;
    public static TaczConfigSpec.BooleanValue SERVER_HITBOX_LATENCY_FIX;
    public static TaczConfigSpec.DoubleValue SERVER_HITBOX_LATENCY_MAX_SAVE_MS;
     ...
     */
    private static void serverConfig(TaczConfigSpec.Builder builder) {
