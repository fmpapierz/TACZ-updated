...
public class SyncConfig {
    ...
    public static TaczConfigSpec.ConfigValue<List<String>> INTERACT_KEY_WHITELIST_BLOCKS;
    public static TaczConfigSpec.ConfigValue<List<String>> INTERACT_KEY_WHITELIST_ENTITIES;
    public static TaczConfigSpec.ConfigValue<List<String>> INTERACT_KEY_BLACKLIST_BLOCKS;
    public static TaczConfigSpec.ConfigValue<List<String>> INTERACT_KEY_BLACKLIST_ENTITIES;
    public static TaczConfigSpec.BooleanValue ENABLE_TABLE_FILTER;
    public static TaczConfigSpec.BooleanValue SERVER_SHOOT_NETWORK_V;
    public static TaczConfigSpec.BooleanValue SERVER_SHOOT_COOLDOWN_V;

    // 三个全局系数，用于客户端枪械文本提示，需要同步
    public static TaczConfigSpec.DoubleValue DAMAGE_BASE_MULTIPLIER;
    public static TaczConfigSpec.DoubleValue ARMOR_IGNORE_BASE_MULTIPLIER;
    public static TaczConfigSpec.DoubleValue HEAD_SHOT_BASE_MULTIPLIER;
    public static TaczConfigSpec.DoubleValue WEIGHT_SPEED_MULTIPLIER;

    // 需要同步到客户端，方便客户端 debug 显示碰撞箱
    public static TaczConfigSpec.ConfigValue<List<String>> HEAD_SHOT_AABB;
    // 子弹盒存储上限需要客户端显示支持
    public static TaczConfigSpec.IntValue AMMO_BOX_STACK_SIZE;
    // 客户端需要下载的枪械包
    public static TaczConfigSpec.ConfigValue<List<List<String>>> CLIENT_GUN_PACK_DOWNLOAD_URLS;
    // 禁用趴下战术动作
    public static TaczConfigSpec.BooleanValue ENABLE_CRAWL;
    ...
    public static void interactKey(TaczConfigSpec.Builder builder) {
    ...
    private static void baseMultiplier(TaczConfigSpec.Builder builder) {
    ...
    private static void misc(TaczConfigSpec.Builder builder) {
        builder.push("misc");
