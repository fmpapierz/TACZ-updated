...
public class ModRecipe {
    public static RecipeSerializer<GunSmithTableRecipe> GUN_SMITH_TABLE_RECIPE_SERIALIZER;
    public static RecipeType<GunSmithTableRecipe> GUN_SMITH_TABLE_CRAFTING;

    public static void registerSerializers() {
        GUN_SMITH_TABLE_RECIPE_SERIALIZER = registerSerializer("gun_smith_table_crafting", GunSmithTableSerializer.create());
    }

    public static void registerTypes() {
        GUN_SMITH_TABLE_CRAFTING = registerRecipe("gun_smith_table_crafting", new RecipeType<>() {
            @Override
