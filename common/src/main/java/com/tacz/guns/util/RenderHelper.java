...
public final class RenderHelper {
    ...
    public static void renderFirstPersonArm(LocalPlayer player,
        ...
        // 26.3 去掉了 getPlayerRenderer(player)，只留下泛型 getRenderer。玩家实体拿到的
        // 就是 AvatarRenderer（getPlayerRenderer 从前也只是替调用方做了这个转型），
        // 另一个重载 getRenderer(AvatarRenderState) 这里用不上：本方法拿的是活体玩家。
