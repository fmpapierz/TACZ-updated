 ...
 * 而不是新建 KeyMapping。
 *
 * <h2>与原版攻击钩子（{@code TaczCommonEvents#shouldCancelAttackEntity}）的关系</h2>
 ...
 *
 * <p>Registered on TACZ's {@code InputEvent.MouseButton.Post} in {@code TaczClientEvents#registerListeners}.
 */
