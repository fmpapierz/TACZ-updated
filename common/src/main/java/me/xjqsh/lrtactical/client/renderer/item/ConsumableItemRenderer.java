...
import me.xjqsh.lrtactical.api.client.LrTacticalClientAPI;
...
public class ConsumableItemRenderer
    ...
    public Identifier getTextureLocation(ItemStack stack) {
        return LrTacticalClientAPI.getConsumableDisplay(stack).map(ConsumableDisplayInstance::getTexture).orElse(null);
    }

    @Override
    @Nullable
    public LuaAnimationStateMachine<ConsumableAnimationStateContext> getStateMachine(ItemStack stack) {
        return LrTacticalClientAPI.getConsumableDisplay(stack).map(ConsumableDisplayInstance::getStateMachine).orElse(null);
    }

    @Override
    @Nullable
    public CustomBedrockModel getModel(ItemStack stack) {
        return LrTacticalClientAPI.getConsumableDisplay(stack).map(ConsumableDisplayInstance::getModel).orElse(null);
    }
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext ctx, PoseStack poseStack,
        ...
        ConsumableDisplayInstance display = LrTacticalClientAPI.getConsumableDisplay(stack).orElse(null);
        if (display == null) {
