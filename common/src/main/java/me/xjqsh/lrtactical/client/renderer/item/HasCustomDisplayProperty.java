...
public record HasCustomDisplayProperty() implements ConditionalItemModelProperty {
    ...
    public boolean get(ItemStack stack,
        ...
        return LrTacticalClientAPI.getMeleeDisplay(stack).isPresent()
                || LrTacticalClientAPI.getThrowableDisplay(stack).isPresent()
                || LrTacticalClientAPI.getConsumableDisplay(stack).isPresent();
    }
