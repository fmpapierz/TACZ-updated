 ...
 *
 * <p>The holders are assigned by {@link #init()}, which {@code TaczRegistration} calls while the mob effect
 * registry is open, rather than by the static initialiser: entity, HUD and sound code refer to this class, and
 * touching it early must not register anything outside that window.
 */
public final class ModEffects {
    /** 致盲：屏幕糊白/黑。实际表现见 {@code BlindnessOverlay}。 */
    public static Holder<MobEffect> BLIND;

    /** 耳鸣/失聪：压低所有音效音量。实际表现见 {@code DeafenState}。 */
