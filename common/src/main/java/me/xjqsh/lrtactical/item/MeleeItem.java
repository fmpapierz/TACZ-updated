...
public class MeleeItem extends Item implements IAnimationItem, IMeleeWeapon, cn.sh1rocu.tacz.api.extension.IItem {
     ...
     * {@code ClientSetupEvent#registerBuiltinItemRenderers} 里被登记进 {@code BuiltinItemRendererRegistry}，
     ...
     *
     * <p>The renderer is only referenced from the nested {@code Client} class: dedicated servers load this item class
     * but have no renderer classes.
     */
    @Override
